...
/*
 ...
 tag
 = hash:[#] word:[a-z\-]+ { return '#' + word.join(""); }

 text
 = word:[a-zA-Z0-9"\t ]+ { return word.join("").trim(); }
...
module.exports = (function() {
    ...
    function parse(input) {
        var options = arguments.length > 1 ? arguments[1] : {},
            ...
            peg$c17 = function(hash, word) { return '#' + word.join(""); },
            peg$c18 = /^[a-zA-Z0-9"\t ]/,
            peg$c19 = { type: "class", value: "[a-zA-Z0-9\"\\t ]", description: "[a-zA-Z0-9\"\\t ]" },
            peg$c20 = function(word) { return word.join("").trim(); },
            peg$c21 = /^[ \t\r\n]/,
